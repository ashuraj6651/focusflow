    ...
    <div className="mx-auto max-w-6xl p-5 md:p-8 lg:p-10 space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-white/35">Manage your study subjects and track progress</p>
        </div>
        ...
        <Dialog open={addOpen} onOpenChange={setAddOpen}>
          ...
          <DialogContent className="bg-[#131316]/95 backdrop-blur-2xl border-white/[0.08] rounded-3xl sm:max-w-md">
            <DialogHeader>
      ...
      <GlassCard className="bg-gradient-to-r from-purple-600/20 to-purple-900/20 border-purple-500/20">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-white/35">Total Study Hours</p>
          ...
          <AnimatePresence mode="popLayout">
            {subjects.map((subject, index) => {
              ...
              return (
                ...
                >
                  <div className="rounded-3xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl p-5 space-y-4 hover:border-white/[0.12] transition-colors">
                    {/* Subject Header */}
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <Badge
                        ...
                        className={cn(
                          'shrink-0 text-xs',
                          progress >= 100
                            ? 'border-green-500/[0.12] text-green-400 bg-green-500/[0.08]'
                            : 'border-white/[0.06] text-white/35 bg-white/[0.03]'
                        )}
                      >
                    ...
                    {subject.upcomingExam && daysUntilExam !== null && (
                      <div
                        className={cn(
                          ...
                          daysUntilExam <= 7
                            ? 'bg-red-500/10 text-red-400 border border-red-500/[0.12]'
                            : daysUntilExam <= 30
                            ? 'bg-yellow-500/10 text-yellow-400 border border-yellow-500/[0.12]'
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <SelectTrigger
                          size="sm"
                          className="h-7 text-xs border-white/[0.06] bg-white/[0.03] text-white/70 w-auto"
                        >
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="border-white/[0.06] bg-[#131316]/95 backdrop-blur-2xl">
                      ...
                      >
                        <DialogTrigger asChild>
                          <Button
                            variant="outline"
                            size="sm"
                            className="flex-1 h-8 gap-1.5 border-white/[0.06] bg-white/[0.03] text-white/70 hover:bg-white/[0.08] hover:text-white text-xs"
                          >
                            <Plus className="size-3" />
                            Add Hours
                          </Button>
                        </DialogTrigger>
                        <DialogContent className="bg-[#131316]/95 backdrop-blur-2xl border-white/[0.08] rounded-3xl sm:max-w-sm">
                          <DialogHeader>
                                  ...
                                  <button
                                    ...
                                    className={cn(
                                      ...
                                      hoursToAdd === h
                                        ...
                                        : 'border-white/[0.06] bg-white/[0.03] text-white/35 hover:bg-white/[0.08]'
                                    )}
                                  >
                                    {h}h
                                  </button>
                          ...
                          <div className="space-y-4">
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                className="border-white/[0.06] bg-white/[0.03] text-white [color-scheme:dark]"
                              />
                            </div>

    ...
    <div className="mx-auto max-w-6xl p-5 md:p-8 lg:p-10 space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-white/35">Set targets, track progress, earn badges</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="border-white/[0.06] bg-white/[0.03] text-white placeholder:text-white/30 min-h-[60px]"
                />
              </div>
      ...
      {earnedBadges.length > 0 && (
        <GlassCard className="bg-gradient-to-r from-yellow-600/10 to-orange-600/10 border-yellow-500/10">
          <div className="flex items-center gap-2 mb-3">
            ...
            <Badge className="bg-yellow-500/[0.08] text-yellow-400 border-yellow-500/[0.12] ml-auto">
          ...
          <div className="flex flex-wrap gap-2">
            {earnedBadges.map((goal, i) => (
              <motion.div
                ...
                className="flex items-center gap-2 rounded-2xl border border-yellow-500/[0.12] bg-yellow-500/[0.08] px-3 py-2"
              >
          ...
          {(['daily', 'weekly', 'monthly', 'yearly'] as GoalType[]).map((type) => {
            ...
            return (
              <TabsTrigger
                ...
                value={type}
                className={cn(
                  'data-[state=active]:bg-white/[0.08] data-[state=active]:text-white text-white/35 gap-1.5',
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            goal.completed
                              ? 'bg-green-500/5 border-green-500/[0.12]'

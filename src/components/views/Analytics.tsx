...
const CustomTooltip = ({ active, payload, label }: { active?: boolean; payload?: Array<{ value: number; name: string; color?: string }>; label?: string }) => {
  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-black/80 px-3 py-2 text-sm backdrop-blur-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <GlassCard>
          <div className="text-center">
            ...
            <p className="text-white/40 text-sm">Current Streak</p>
            <p className="text-3xl font-bold text-white mt-1">{currentStreak} <span className="text-base text-white/40">days</span></p>
          </div>
        </GlassCard>
        <GlassCard>
          <div className="text-center">
            <TrendingUp className="w-8 h-8 text-green-400 mx-auto mb-2" />
            <p className="text-white/40 text-sm">Longest Streak</p>
            <p className="text-3xl font-bold text-white mt-1">{longestStreak} <span className="text-base text-white/40">days</span></p>
          </div>
        </GlassCard>
        <GlassCard>

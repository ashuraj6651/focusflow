...
function SortableChecklistItem({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group relative flex items-center gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-md px-4 py-3 transition-colors',
      ...
      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
        ...
        <AlertDialog>
          ...
          <AlertDialogContent className="bg-[#131316]/95 backdrop-blur-2xl border-white/[0.08] rounded-3xl">
            ...
            <AlertDialogFooter>
              <AlertDialogCancel className="border-white/[0.06] text-white/40 hover:text-white/90 hover:bg-white/[0.06]">
                Cancel
              </AlertDialogCancel>
              <AlertDialogAction
                onClick={onDelete}
...
export default function Checklist() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-5 md:p-8 lg:p-10 space-y-8">
      {/* Header */}
      <div>
      ...
      <GlassCard className="space-y-3">
        ...
        <div className="relative">
          <Progress
            value={percentage}
            className="h-3 bg-white/[0.03] [&>[data-slot=progress-indicator]]:bg-gradient-to-r [&>[data-slot=progress-indicator]]:from-purple-600 [&>[data-slot=progress-indicator]]:to-purple-400 [&>[data-slot=progress-indicator]]:transition-all [&>[data-slot=progress-indicator]]:duration-500"
          />
      ...
      <GlassCard className="flex items-center gap-3 p-3">
        <div className="flex-1 relative">
          ...
          <Input
            ...
            className="pl-9 h-11 bg-white/[0.03] border-white/[0.06] text-white/90 placeholder:text-white/25 text-sm rounded-xl"
          />
        </div>
        <Button
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          <TabsList className="bg-white/[0.03] border border-white/[0.06]">
            {[
              ...
              <TabsTrigger
                key={t.value}
                value={t.value}
                className="data-[state=active]:bg-purple-600/30 data-[state=active]:text-purple-300 text-white/35 text-xs"
              >
                {t.label}
              </TabsTrigger>
            ))}
        ...
        <div className="relative flex-1 sm:max-w-xs w-full">
          ...
          <Input
            ...
            className="pl-9 h-8 bg-white/[0.03] border-white/[0.06] text-white/90 placeholder:text-white/25 text-xs rounded-xl"
          />
        </div>
        ...
        {searchQuery && (
          <Badge
            variant="outline"
            className="text-[10px] text-purple-400 border-purple-500/[0.12] bg-purple-500/[0.08] shrink-0"
          >

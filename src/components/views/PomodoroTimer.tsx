...
export default function PomodoroTimer() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-5 md:p-8 lg:p-10 space-y-8 pb-8">
      {/* Timer Section */}
        ...
        <div className="mt-8 flex items-center gap-3">
          ...
          {(isRunning || isPaused) && (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={resetTimer}
              className="flex h-12 w-12 items-center justify-center rounded-full bg-white/[0.03] text-white/70 border border-white/[0.06] transition-colors hover:bg-white/[0.08] hover:text-white"
              ...
              <div className="space-y-5 border-t border-white/[0.06] px-6 py-5">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 rounded-xl bg-white/[0.03] border border-white/[0.06] py-2.5 text-sm font-medium text-white/70 transition-colors hover:bg-white/[0.08] hover:text-white"
                  >
                    Cancel
                  </button>
                </div>

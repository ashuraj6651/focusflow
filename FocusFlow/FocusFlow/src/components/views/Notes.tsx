    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-white/50">Capture ideas, summaries, and key concepts</p>
        </div>
        <Button
      ...
      <Dialog open={createOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="border-white/10 bg-[#1a1a2e] sm:max-w-2xl max-h-[85vh] flex flex-col">
          <DialogHeader>
          ...
          <div className="flex-1 overflow-y-auto space-y-4 pr-1">
            ...
            <div className="space-y-2">
              ...
              {showPreview ? (
                <div className="min-h-[200px] max-h-[400px] overflow-y-auto rounded-xl border border-white/10 bg-white/5 p-4 text-sm text-white/80 prose prose-invert prose-sm max-w-none">
                  {noteContent ? (
                ...
                <Textarea
                  ...
                  onBlur={handleBlur}
                  className="min-h-[200px] max-h-[400px] border-white/10 bg-white/5 text-white placeholder:text-white/30 resize-none"
                />
              )}
            </div>
          </div>

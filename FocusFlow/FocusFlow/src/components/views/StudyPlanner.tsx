...
function SortableTaskCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group relative flex items-start gap-3 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-4 transition-colors',
...
function TaskDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpen}>
      <DialogContent className="bg-[#1a1a2e]/95 backdrop-blur-xl border-white/10 sm:max-w-lg">
        <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="bg-white/5 border-white/10 text-white/90 placeholder:text-white/25"
              autoFocus
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              className="bg-white/5 border-white/10 text-white/90 placeholder:text-white/25 min-h-[60px]"
              rows={2}
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              >
                <SelectTrigger className="bg-white/5 border-white/10 text-white/90 w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-[#1a1a2e]/95 backdrop-blur-xl border-white/10">
                  {PRIORITIES.map((p) => (
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="bg-white/5 border-white/10 text-white/90 [color-scheme:dark]"
              />
            </div>
            <div className="space-y-1.5">
          ...
          <DialogFooter>
            <Button
              ...
              className="border-white/10 text-white/60 hover:text-white/90 hover:bg-white/10"
            >
              Cancel
            </Button>
            <Button
        ...
        <TabsList className="bg-white/5 border border-white/10">
          {['daily', 'weekly', 'monthly'].map((v) => (
            <TabsTrigger
              key={v}
              value={v}
              className="data-[state=active]:bg-purple-600/30 data-[state=active]:text-purple-300 text-white/50"
            >
            ...
            <div className="space-y-3">
              <div className="space-y-1.5">
                ...
                <Select value={filterCategory} onValueChange={setFilterCategory}>
                  <SelectTrigger className="bg-white/5 border-white/10 text-white/80 w-full text-xs h-8">

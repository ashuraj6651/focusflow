    ...
    <AnimatePresence>
      ...
      >
        <button
          ...
          className="flex items-center gap-2 rounded-full bg-purple-600/90 px-4 py-2.5 text-white shadow-2xl shadow-purple-500/30 backdrop-blur-sm transition-all hover:bg-purple-500 hover:shadow-purple-500/50"
        >
